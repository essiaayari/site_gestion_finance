...
import { FormulaireConsultantComponent } from '../formulaires/formulaire-consultant/formulaire-consultant.component';
...
code_postal:number=0;
  ...
  constructor(private consultantservice:ConsultantService,private afs:AngularFirestore, private renderer: Renderer2, private el: ElementRef,private modalService: NgbModal ){}
  ...
  this.renderer.listen(this.el.nativeElement, 'click', (event) => {
   ...
   this.code_postal=0;
    ...
    openconsultantFormModal() {
      const modalOptions: NgbModalOptions = {
        size: 'lg' 
      };
    
      const modalRef = this.modalService.open(FormulaireConsultantComponent, modalOptions);
      modalRef.componentInstance.clientData = this.selectedconsultant;
