...
import { FormulaireChequeTraiteComponent } from '../../formulaires/formulaire-cheque-traite/formulaire-cheque-traite.component';

@Component({
  selector: 'app-cheque-traite',
  templateUrl: './cheque-traite.component.html',
  styleUrl: './cheque-traite.component.css'
})
export class ChequeTraiteComponent {
   // Pour le formulaire
...
updatecheque_traite() {
  ...
  opencheque_traiteFormModal() {
    const modalOptions: NgbModalOptions = {
      size: 'lg' 
    };
  
    const modalRef = this.modalService.open(FormulaireChequeTraiteComponent, modalOptions);
    modalRef.componentInstance.clientData = this.selectedcheque_traite;
