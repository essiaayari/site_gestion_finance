...
@Component({
  selector: 'app-formulaire-fournisseurs',
  templateUrl: './formulaire-fournisseurs.component.html',
  styleUrl: './formulaire-fournisseurs.component.css'
})
export class FormulaireFournisseursComponent {
  ...
  current: number = 1;
  steps: number = 0;
  @Input() fourdata: any; // Pass data to the modal
