...
@Component({
  selector: 'app-formulaire-devis',
  templateUrl: './formulaire-devis.component.html',
  styleUrl: './formulaire-devis.component.css'
})
export class FormulaireDevisComponent {
...
this.getcompanydata();
    ...
    adddevis(){
      ...
      this.devisservice.adddevis(this.devis_obj);
      this.resetform();
