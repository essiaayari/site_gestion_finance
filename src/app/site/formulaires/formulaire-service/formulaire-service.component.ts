...
@Component({
  ...
  styleUrl: './formulaire-service.component.css'
})
export class FormulaireServiceComponent {
  ...
  constructor(private sservice:ServiceService,private afs:AngularFirestore, private renderer: Renderer2, private el: ElementRef,private modalService: NgbModal,private router:Router){}
